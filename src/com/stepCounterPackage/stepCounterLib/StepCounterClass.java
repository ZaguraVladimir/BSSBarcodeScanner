...
public class StepCounterClass implements Runnable, SensorEventListener {
    ...
    private void setNextElement(TypeValues typeVal, double newValue) {
        ...
        switch (typeVal) {
            case METERING:
                m_ListAngleMetering.setElementAt(newValue, m_ItData);
                break;
            case SMOOTH:
                m_ListAngleSmooth.setElementAt(newValue, m_ItData);
                break;
            case MINSTAT:
                m_ListAngleMin.setElementAt(newValue, m_ItData);
                break;
            case INSTEP:
                m_ListInStep.setElementAt(newValue, m_ItData);
                break;
            default:
                ;
        }
    ...
    private void setElement(int itElem, TypeValues typeVal, double newValue) {
        ...
        switch (typeVal) {
            case METERING:
                m_ListAngleMetering.setElementAt(newValue, itCurr);
                break;
            case SMOOTH:
                m_ListAngleSmooth.setElementAt(newValue, itCurr);
                break;
            case MINSTAT:
                m_ListAngleMin.setElementAt(newValue, itCurr);
                break;
            case INSTEP:
                m_ListInStep.setElementAt(newValue, itCurr);
                break;
            default:
                ;
        }
    ...
    private double getElement(int itElem, TypeValues typeVal) {
        ...
        switch (typeVal) {
            case METERING:
                result = m_ListAngleMetering.get(itCurr);
                break;
            case SMOOTH:
                result = m_ListAngleSmooth.get(itCurr);
                break;
            case MINSTAT:
                result = m_ListAngleMin.get(itCurr);
                break;
            case INSTEP:
                result = m_ListInStep.get(itCurr);
                break;
            default:
                ;
        }
